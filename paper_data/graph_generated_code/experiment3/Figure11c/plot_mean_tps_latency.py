...
# Script location: paper_data/graph_generated_code/experiment3/faulty/
SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parents[3]
DATA_ROOT = REPO_ROOT / "paper_data" / "original_data" / "Figure11c"
...
def protocol_from_path(rel: Path) -> str:
    ...
    mapping = {
        ...
        "mahi_faulty": "Mahi-Mahi",
        "mahi-mahi-faulty": "Mahi-Mahi",
        "DAG-rider-result": "DAG-Rider",
        "rider_faulty": "DAG-Rider",
        "Manta-result": "Manta",
        "manta_faulty": "Manta",
    }
...
def main() -> None:
    ...
    out_pdf = OUT_DIR / "faulty_graph.pdf"
    fig.savefig(out_pdf)
