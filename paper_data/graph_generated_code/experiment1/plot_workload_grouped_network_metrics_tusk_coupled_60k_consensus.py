...
Reads flat summary ``*.txt`` files from ``paper_data/original_data/Figure9b``.
"""
...
DATA_ROOT = REPO_ROOT / "paper_data" / "original_data" / "Figure9b"
OUT_DIR = REPO_ROOT / "results" / "regenerate_graphs"
OUTPUT_PATHS = [
    OUT_DIR / "workload_grouped_network_metrics_tusk_coupled_60k_consensus.pdf",
    OUT_DIR / "workload_grouped_network_metrics_tusk_coupled_60k_consensus.png",
]
TARGET_RATE = 60_000
