...
The file [settings.json](<REDACTED_REPO_URL>) (located in [narwhal/benchmarks](<REDACTED_REPO_URL>)) contains all the configuration parameters of the testbed to deploy. Its content looks as follows:
```json
{
    "key": {
        "name": "aws",
...
The AWS instances are orchestrated with [Fabric](http://www.fabfile.org) from the file [fabfile.py](<REDACTED_REPO_URL>) (located in [narwhal/benchmarks](<REDACTED_REPO_URL>)); you can list all possible commands as follows:
```
