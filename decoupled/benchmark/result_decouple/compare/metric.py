#!/usr/bin/env python3
"""
Plot latency and TPS for all network/workload combinations at 40k.
...
OUTPUT_PATHS = [
    SCRIPT_DIR / "network_workload_combo_metrics_decouple_40k.pdf",
    SCRIPT_DIR / "network_workload_combo_metrics_decouple_40k.png",
]
...
def plot_combo_metrics(output_paths: list[Path]):
    ...
    ax_tps.set_xticks([])
    ax_tps.set_xlabel("Decoupled Architecture at 40k Offered Load", labelpad=2)
