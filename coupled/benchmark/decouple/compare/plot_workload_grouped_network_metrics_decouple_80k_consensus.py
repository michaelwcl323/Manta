#!/usr/bin/env python3
"""
Plot consensus latency and TPS for all workload/network combinations at 80k,
...
OUTPUT_PATHS = [
    SCRIPT_DIR / "consensus" / "workload_grouped_network_metrics_decouple_80k_consensus.pdf",
    SCRIPT_DIR / "consensus" / "workload_grouped_network_metrics_decouple_80k_consensus.png",
]
